...
class WaterWqStatV2Search
{
  ...
  public function __construct(Request $request, $pagination = false)
  {
    ...
    private function process()
    {
        ...
        $q =  DB::table('sp_wq_status')
            ->leftjoin('sp_infrastructure', 'sp_wq_status.id', '=', 'sp_infrastructure.wq_status_id')
            ...
            ->select('sp_wq_status.*', 'sp_infrastructure.tech_type', 'sp_infrastructure.drinking_use', 'sp_infrastructure.water_id',

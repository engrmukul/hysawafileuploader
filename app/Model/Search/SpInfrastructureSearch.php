...
//
//    $q = SPInfrastructure::with('school')->orderBy('id', 'DESC')
//
...
//      {
//          $query->whereHas('school', function($query2) use($upid)
//          {
...
//      {
//          $query->whereHas('school', function($query2) use($unid)
//          {
...
//      if(!empty($tech_type))
//      {
//        $query->where('tech_type', '=', $tech_type);
//      }
//
//    if(!empty($drinking_use))
//    {
//        $query->where('drinking_use', '=', $drinking_use);
//    }
//
//    if(!empty($functional_status))
//    {
...
//  }
    ...
    private function process()
    {
        ...
        $q =  DB::table('sp_infrastructure')
            ...
            ->select('sp_infrastructure.*', 'sp_school.unid', 'sp_school.distid', 'sp_school.id as school_id',
            ...
            ->where(function($query) use($request) {
                ...
                {
                    $query->where('water_id', 'like', "%$keyword%")

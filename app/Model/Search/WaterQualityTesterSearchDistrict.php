...
class WaterQualityTesterSearchDistrict
{
  private $datas;
  private $request;
  private $pagination;
  ...
  private function process()
  {
    ...
    if(!empty($TW_No)) {
        $q = Water::join('water_quality_results', 'water_quality_results.water_id', '=', 'tbl_water.id')
            ...
            ->select('tbl_water.id', 'tbl_water.CDF_no', 'tbl_water.Technology_Type', 'tbl_water.Ward_no', 'tbl_water.Village', 'tbl_water.App_date', 'tbl_water.depth',
                'tbl_water.Landowner', 'tbl_water.Caretaker_male', 'tbl_water.Caretaker_female', 'tbl_water.unid', 'tbl_water.upid', 'tbl_water.proj_id', 'tbl_water.distid',

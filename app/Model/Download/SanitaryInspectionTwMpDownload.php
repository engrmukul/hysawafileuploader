...
class SanitaryInspectionTwMpDownload
{
    private $rows;
    private $request;
    ...
    public function download()
    {
        ...
        \Excel::create(date("d-m-Y").' SafePani Sanitary Inspection v2 (Motorpump)', function($excel) use ($rows) {
            $excel->sheet('Sheetname', function ($sheet) use ($rows) {
                ...
                foreach ($rows as $row) {
                    ...
                    $sheet->row($rowIndex, [
                        ...
                        $row['accnt_score'],
                        $row['sanitary_risk'],
                        $row->SpSanAnswer->bhmpq1,
                        $row->SpSanAnswer->bhmpq2,
                        $row->SpSanAnswer->bhmpq3,
                        $row->SpSanAnswer->bhmpq4,
                        $row->SpSanAnswer->bhmpq5,
                        $row->SpSanAnswer->bhmpq6,
                        $row->SpSanAnswer->bhmpq7,
                        $row->SpSanAnswer->bhmpq8,
                        $row->SpSanAnswer->bhmpq9,
                        $row->SpSanAnswer->bhmpq10,
                        $correctives,
                        $image1,
                        $image2,
                        $image3,

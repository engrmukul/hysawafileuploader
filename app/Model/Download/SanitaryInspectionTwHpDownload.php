...
class SanitaryInspectionTwHpDownload
{
    private $rows;
    private $request;
    ...
    public function download()
    {
        ...
        \Excel::create(date("d-m-Y").' SafePani Sanitary Inspection v2 (Handpump)', function($excel) use ($rows) {
            $excel->sheet('Sheetname', function ($sheet) use ($rows) {
                ...
                foreach ($rows as $row) {
                    ...
                    $sheet->row($rowIndex, [
                        ...
                        $row['accnt_score'],
                        $row['sanitary_risk'],
                        $row->SpSanAnswer->twhpq1,
                        $row->SpSanAnswer->twhpq2,
                        $row->SpSanAnswer->twhpq3,
                        $row->SpSanAnswer->twhpq4,
                        $row->SpSanAnswer->twhpq5,
                        $row->SpSanAnswer->twhpq6,
                        $row->SpSanAnswer->twhpq7,
                        $row->SpSanAnswer->twhpq8,
                        $row->SpSanAnswer->twhpq9,
                        $correctives,
                        $image1,
                        $image2,
                        $image3,

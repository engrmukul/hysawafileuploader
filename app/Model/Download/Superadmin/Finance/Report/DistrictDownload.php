...
class DistrictDownload
{
  public function download(Request $request)
  {
    ...
    \Excel::create('Finance-Report-District-'.time(), function($excel) use($request) {
      $excel->sheet('Sheetname', function($sheet) use($request) {
        ...
        $financeData2 = FinanceData::where('distid', $request->district_id)
        ...
        $financeData = FinanceData::where('distid', $request->district_id)
          ->where(function($q) use ($request) {

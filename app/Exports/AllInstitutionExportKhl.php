            ...
            ->select(
                ...
                DB::raw("
                    (
                        ...
                        WHERE ai.school_id = sp_school.id
                          AND ai.is_active = 1
                    ) as currently_active_infrastructure
                "),
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // "Within 1174" = second last column
                $within1174Col = Coordinate::stringFromColumnIndex($lastColumnIndex - 1);

                $sheet->getStyle("{$within1174Col}4:{$within1174Col}{$lastRow}")
                    ->getAlignment()
